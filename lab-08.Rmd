...
##get some errors, Some title values don’t contain (, so date is assigned NA. 
##Some title values contain multiple (, and separate() keeps only the first split.
##Some date values don’t just contain valid years (e.g., "circa 1890" or "Unknown") and as.numeric() converts them to NA.
